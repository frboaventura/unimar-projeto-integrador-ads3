        ...
        <table border="4">
            ...
            <?php
                ...
                while($dado = mysqli_fetch_assoc($dados_select)) {
                        ...
                        echo '<td>';
                        echo '<form method="GET" action="excluir.php">';
                        echo '<button class="btn btn-danger btn-sm" type="submit" name="btnExcluir" value="'.$dado['id_dev'].'"> Excluir </button>';
                        echo '</form>';
                        echo '</td>';
                        echo '</tr>';
                }
